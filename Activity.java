	...
	public static void saveToDB(Map<String, String> hmapget){
		...
		for (Map.Entry<String, String> entry : hmapget.entrySet()) {
	    	...
	    	if(cursor.hasNext()) {
	        	...
	        	Document doc = new Document("ndate", ndate)
		            .append("nhour", nhour)
		            .append("count", nCount)
